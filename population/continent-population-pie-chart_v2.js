...
lib.ssMetadata = [
		{name:"continent_population_pie_chart_v2_atlas_1", frames: [[1494,944,302,469],[1494,1415,302,469],[1494,0,474,470],[1494,472,474,470],[0,0,1384,800],[0,802,745,944],[747,802,745,944]]},
		{name:"continent_population_pie_chart_v2_atlas_2", frames: [[738,957,161,44],[1394,645,177,163],[389,547,740,84],[323,889,198,102],[0,0,387,361],[0,363,387,361],[389,0,792,174],[389,176,465,271],[856,176,465,271],[1984,0,27,473],[199,889,122,195],[2013,0,27,473],[389,633,850,65],[389,449,1014,96],[0,726,1092,127],[1068,911,178,48],[1669,429,35,109],[1223,824,341,85],[1323,0,558,162],[523,889,323,44],[0,1031,185,96],[1241,645,112,44],[848,911,218,44],[1131,547,90,44],[1977,475,71,44],[523,935,213,44],[0,855,1221,32],[0,889,197,140],[1323,164,252,166],[1323,332,405,95],[1577,164,405,95],[1730,415,245,127],[1730,261,233,152],[1405,429,262,89],[1241,547,772,47],[1094,700,298,122],[1241,596,772,47]]}
];
...
(lib.CachedBmp_57 = function() {
	this.initialize(ss["continent_population_pie_chart_v2_atlas_2"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_47 = function() {
	this.initialize(ss["continent_population_pie_chart_v2_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.arrow = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(15.45,14.5,0.5,0.5);
...
// stage content:
(lib.continentpopulationpiechart_v2 = function(mode,startPosition,loop) {
	...
	this.continue1.setTransform(850.2,678.2,1,1,0,0,0,138.4,39.6);
	this.continue1._off = true;
	this.continue1.visible = false;

	this.timeline.addTween(cjs.Tween.get(this.continue1).wait(1).to({_off:false},0).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.africa1_label},{t:this.northamerica1_label},{t:this.southamerica1_label},{t:this.europe1_label},{t:this.australia1_label},{t:this.asia1_label}]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/continent_population_pie_chart_v2_atlas_1.png", id:"continent_population_pie_chart_v2_atlas_1"},
		{src:"images/continent_population_pie_chart_v2_atlas_2.png", id:"continent_population_pie_chart_v2_atlas_2"}
	],
	preloads: []
};
